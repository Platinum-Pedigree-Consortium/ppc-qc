#' Function to calculate various assembly statistics
#'
#' @param contig.sizes A numeric vector containing assembly contig sizes.
#' @param asm.index A unique assembly identifier.
#' @return A \code{data.frame} of calculated assebmly statistics
